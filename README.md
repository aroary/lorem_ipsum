...
#### The language can be changes by running the `Download and change lorem ipsum language` command or by manually adding the `lorem_ipsum.language` setting to the workspace `.vscode/settings.json` file with an `array` of `string`s you want to use.
